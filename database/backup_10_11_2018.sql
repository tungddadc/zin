...
MySQL - 10.3.8-MariaDB : Database - demosource
*********************************************************************
*/
...
insert  into `st_product`(`id`,`thumbnail`,`url_video`,`is_status`,`is_featured`,`displayed_time`,`viewed`,`created_time`,`updated_time`) values (1,'product/ipad-air-2-ipad-6/man-hinh-apple-Ipad-Air-2.jpg',NULL,1,0,NULL,6803,'2018-11-10 03:15:48','2018-11-10 18:08:24');
...
insert  into `st_product_category`(`product_id`,`category_id`) values (1,1);

/*Table structure for table `st_product_property` */

DROP TABLE IF EXISTS `st_product_property`;

CREATE TABLE `st_product_property` (
  `product_id` int(11) unsigned NOT NULL,
  `property_id` int(11) unsigned NOT NULL,
  UNIQUE KEY `product_id` (`product_id`,`property_id`),
  KEY `fk_product_id` (`product_id`),
  KEY `fk_property_id` (`property_id`),
  CONSTRAINT `fk_product_property_productid` FOREIGN KEY (`product_id`) REFERENCES `st_product` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `fk_product_property_proid` FOREIGN KEY (`property_id`) REFERENCES `st_property` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

/*Data for the table `st_product_property` */
...
insert  into `st_product_translations`(`id`,`language_code`,`slug`,`title`,`description`,`content`,`meta_title`,`meta_description`,`meta_keyword`) values (1,'vi','apple-ipad-air-2-ipad-6','Apple Ipad Air 2 / Ipad 6','Apple Ipad Air 2 / Ipad 6','<p>Apple Ipad Air 2 / Ipad 6</p>','Apple Ipad Air 2 / Ipad 6','Apple Ipad Air 2 / Ipad 6','');

/*Table structure for table `st_property` */

DROP TABLE IF EXISTS `st_property`;

CREATE TABLE `st_property` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `thumbnail` varchar(255) DEFAULT NULL,
  `class` varchar(100) DEFAULT NULL,
  `type` varchar(100) DEFAULT 'post' COMMENT 'type theo đúng tên controller',
...
/*Data for the table `st_property` */

/*Table structure for table `st_property_translations` */

DROP TABLE IF EXISTS `st_property_translations`;

CREATE TABLE `st_property_translations` (
  `id` int(11) unsigned NOT NULL,
  `language_code` char(2) NOT NULL,
  `title` varchar(255) NOT NULL,
  `description` mediumtext DEFAULT NULL,
  ...
  `meta_keyword` varchar(255) DEFAULT NULL,
  `content` mediumtext NOT NULL,
  UNIQUE KEY `ap_category_translations_id_language_code_pk` (`id`,`language_code`),
  CONSTRAINT `st_property_translations_ibfk_1` FOREIGN KEY (`id`) REFERENCES `st_property` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `st_property_translations` */
...
CREATE TABLE `st_users` (
  ...
  `address_book` text CHARACTER SET utf8 DEFAULT NULL,
