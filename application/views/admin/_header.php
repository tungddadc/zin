...
<header class="main-header">
    ...
    <a href="<?php echo BASE_ADMIN_URL ?>" class="logo">
        ...
        <span class="logo-lg"><b>STEVEN</b> CMS</span>
    </a>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="<?php echo site_url('admin/users/profile');?>" class="btn btn-default btn-flat">Profile</a>
                            </div>
                            <div class="pull-right">
                                <a href="<?php echo site_url('admin/auth/logout');?>" class="btn btn-default btn-flat">Logout</a>
                            </div>
                        </li>
                    </ul>
                </li>
