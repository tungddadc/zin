...
<div class="form-group">
    ...
    <hr>
    <input name="language[<?php echo $lang_code ?>][meta_title_thanhchi]" placeholder="Meta Title Thanhchi" class="form-control" type="text" maxlength="<?php echo $this->config->item('SEO_title_maxlength') ?>"/>
</div>
<div class="form-group">
    <label>Url</label>
    <input name="language[<?php echo $lang_code ?>][slug]" placeholder="Link" class="form-control" type="text" />
    <hr>
    <input name="language[<?php echo $lang_code ?>][slug_thanhchi]" placeholder="Link" class="form-control" type="text" />
</div>
<div class="form-group">
    ...
    <hr>
    <textarea name="language[<?php echo $lang_code ?>][meta_description_thanhchi]" placeholder="Meta Description Thanhchi" class="form-control content_product" rows="5"></textarea>
</div>
<div class="form-group">
    ...
    <hr>
    <input value="" name="language[<?php echo $lang_code ?>][meta_keyword_thanhchi]" placeholder="Meta Keyword Thanhchi" class="form-control tagsinput" data-role="tagsinput" type="text" />
</div>
<div class="google">
