            ...
            <div class="form-group m-form__group row align-items-center">
              ...
              <div class="col-md-4">
                <div class="m-form__group m-form__group--inline">
                  ...
                  <div class="m-form__control">
                    <select class="form-control m-bootstrap-select filter_category" name="category_id"
            ...
            <div class="m-portlet__head-tools">
              <ul class="nav nav-tabs m-tabs-line m-tabs-line--primary m-tabs-line--2x" role="tablist">
                <li class="nav-item m-tabs__item">
                  <a class="nav-link m-tabs__link active show" data-toggle="tab" href="#tab_language" role="tab"
                     aria-selected="true">
              ...
              <div class="tab-pane active show" id="tab_language" role="tabpanel">
                  ...
                  <div class="m-portlet__head-tools">
                    <ul class="nav nav-tabs m-tabs-line m-tabs-line--primary m-tabs-line--2x" role="tablist">
                      <?php if (!empty($this->config->item('language_name'))) foreach ($this->config->item('language_name') as $lang_code => $lang_name): ?>
                        <li class="nav-item m-tabs__item">
                          <a class="nav-link m-tabs__link <?php echo ($lang_code === $this->config->item('language_default')) ? 'active show' : '' ?>"
                             data-toggle="tab" href="#tab_<?php echo $lang_code; ?>" role="tab" aria-selected="true">
                ...
                <div class="m-portlet__body">
                  <div class="tab-content">
                    <?php if (!empty($this->config->item('language_name'))) foreach ($this->config->item('language_name') as $lang_code => $lang_name): ?>
                      <div
                          class="tab-pane <?php echo ($lang_code === $this->config->item('language_default')) ? 'active show' : ''; ?>"
                          ...
                          <div class="row">
                            <div class="col-sm-6 col-xs-12">
                              <div class="form-group">
                                <label>Tiêu đề</label>
                                <input name="language[<?php echo $lang_code; ?>][title]"
                                       placeholder="Tiêu đề (<?php echo $lang_name ?>)" class="form-control"
                                       type="text"/>
                              </div>
                              <div class="form-group">
                                <label>Tóm tắt</label>
                                <textarea name="language[<?php echo $lang_code; ?>][description]"
                                          placeholder="Tóm tắt (<?php echo $lang_name ?>)" class="form-control"
                                          rows="5"></textarea>
                              </div>
                              <div class="form-group">
                                <label>Nội dung</label>
                                <textarea name="language[<?php echo $lang_code; ?>][content]"
                  ...
                  <div class="col-lg-6 col-12">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <select name="category_id[]" class="form-control m-select2 category"
                                style="width: 100%;"></select>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group m-input-group m-input-group--air">
                        ...
                        <input type="text" name="thumbnail" onclick="FUNC.chooseImage(this)"
                               class="form-control m-input chooseImage" placeholder="Click để chọn ảnh"
                               aria-describedby="input_thumbnail">
                      </div>
