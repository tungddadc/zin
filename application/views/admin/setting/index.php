			...
			<div class="m-portlet m-portlet--tabs">
					...
					<div class="m-portlet__head-tools">
						<ul class="nav nav-tabs m-tabs-line m-tabs-line--primary m-tabs-line--2x" role="tablist">
							<li class="nav-item m-tabs__item">
								<a class="nav-link m-tabs__link active show" data-toggle="tab" href="#tab_general"
								   role="tab"
								   aria-selected="true">
							...
							<li class="nav-item m-tabs__item">
								<a class="nav-link m-tabs__link" data-toggle="tab" href="#tab_contact" role="tab"
								   aria-selected="false">
							...
							<li class="nav-item m-tabs__item">
								<a class="nav-link m-tabs__link" data-toggle="tab" href="#tab_social" role="tab"
								   aria-selected="false">
							...
							<li class="nav-item m-tabs__item">
								<a class="nav-link m-tabs__link" data-toggle="tab" href="#tab_block" role="tab"
								   aria-selected="false">
							...
							<li class="nav-item m-tabs__item">
								<a class="nav-link m-tabs__link" data-toggle="tab" href="#tab_faq" role="tab"
								   aria-selected="false">
									<i class="la la-bookmark"></i>
									Hỏi đáp
								</a>
							...
							<li class="nav-item m-tabs__item">
								<a class="nav-link m-tabs__link" data-toggle="tab" href="#tab_agency" role="tab"
								   aria-selected="false">
									<i class="la la-bookmark"></i>
									Đại lý
								</a>
							...
							<li class="nav-item m-tabs__item">
								<a class="nav-link m-tabs__link" data-toggle="tab" href="#tab_system" role="tab"
								   aria-selected="false">
									<i class="la la-cog"></i>
									Cấu hình hệ thống
								</a>
				...
				<div class="m-portlet__body">
					<div class="tab-content">
						<div class="tab-pane active show" id="tab_general" role="tabpanel">
							<ul class="nav nav-tabs" role="tablist">
								<?php if (!empty($this->config->item('language_name'))) foreach ($this->config->item('language_name') as $lang_code => $lang_name): ?>
									<li class="nav-item">
										<a class="nav-link <?php echo ($lang_code === $this->config->item('language_default')) ? 'active' : '' ?>"
										   data-toggle="tab" href="#tab_<?php echo $lang_code; ?>" role="tab">
											<img
												src="<?php echo $this->templates_assets . 'images/flag/' . $lang_code . '.png' ?>"
												alt="<?php echo $lang_name; ?>">
											<?php echo $lang_name ?>
										</a>
									</li>
								<?php endforeach; ?>
							...
							<div class="tab-content">
								<?php if (!empty($this->config->item('language_name'))) foreach ($this->config->item('language_name') as $lang_code => $lang_name): ?>
									<div
										class="tab-pane <?php echo ($lang_code === $this->config->item('language_default')) ? 'active' : ''; ?>"
										id="tab_<?php echo $lang_code; ?>" role="tabpanel">
										...
										<div class="form-group">
											...
											<input name="meta[<?php echo $lang_code; ?>][address]" class="form-control"
												   value="<?php echo isset($meta[$lang_code]['address']) ? $meta[$lang_code]['address'] : ''; ?>">
										</div>

										<div class="form-group">
											<label>Địa chỉ văn phòng</label>
											<input name="meta[<?php echo $lang_code; ?>][address_office]"
												   class="form-control"
												   value="<?php echo isset($meta[$lang_code]['address_office']) ? $meta[$lang_code]['address_office'] : ''; ?>">
										</div>

										<div class="form-group">
											<label>Hotline</label>
											<input name="meta[<?php echo $lang_code; ?>][hotline]" class="form-control"
												   value="<?php echo isset($meta[$lang_code]['hotline']) ? $meta[$lang_code]['hotline'] : ''; ?>">
										</div>

										<div class="form-group">
											<label>Email Hotline</label>
											<input name="meta[<?php echo $lang_code; ?>][email]" class="form-control"
												   value="<?php echo isset($meta[$lang_code]['email']) ? $meta[$lang_code]['email'] : ''; ?>">
										</div>
									</div>
								<?php endforeach; ?>
								...
								<div class="form-group">
									...
									<div class="input-group m-input-group m-input-group--air">
										...
										<input type="text" name="favicon"
											   value="<?php echo !empty($favicon) ? $favicon : '' ?>"
											   onclick="FUNC.chooseImage(this)" class="form-control m-input chooseImage"
											   placeholder="Click để chọn ảnh">
									</div>
									<div class="alert m-alert m-alert--default preview text-center mt-1" role="alert">
										<img height="100"
											 src="<?php echo !empty($favicon) ? getImageThumb($favicon, 100, 100) : '' ?>">
									</div>
								</div>

								<div class="form-group">
									<label for="thumbnail">Ảnh đại diện trang chủ Website (Social Share) (200px x
										200px)</label>
									<div class="input-group m-input-group m-input-group--air">
										<div class="input-group-prepend">
                                            <span class="input-group-text">
										...
										<input type="text" name="homepage_thumbnail"
											   value="<?php echo !empty($homepage_thumbnail) ? $homepage_thumbnail : '' ?>"
											   onclick="FUNC.chooseImage(this)" class="form-control m-input chooseImage"
											   placeholder="Click để chọn ảnh">
									</div>
									<div class="alert m-alert m-alert--default preview text-center mt-1" role="alert">
										<img height="100"
											 src="<?php echo !empty($homepage_thumbnail) ? getImageThumb($homepage_thumbnail, 100, 100) : '' ?>">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="alert m-alert m-alert--default preview text-center mt-1" role="alert">
										<img height="70"
											 src="<?php echo !empty($logo) ? getImageThumb($logo, 100, 100) : '' ?>">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="input-group m-input-group m-input-group--air">
										...
										<input type="text" name="watermark"
											   value="<?php echo !empty($watermark) ? $watermark : '' ?>"
											   onclick="FUNC.chooseImage(this)" class="form-control m-input chooseImage"
											   placeholder="Click để chọn ảnh">
									</div>
									<div class="alert m-alert m-alert--default preview text-center mt-1" role="alert">
										<img height="70"
											 src="<?php echo !empty($watermark) ? getImageThumb($watermark, 100, 100) : '' ?>">
									</div>
								</div>


								<div class="form-group">
									<label for="thumbnail">Ảnh popup</label>
									<div class="input-group m-input-group m-input-group--air">
										<div class="input-group-prepend">
                                            <span class="input-group-text">
                                                <i class="la la-picture-o"></i>
										...
										<input type="text" name="popup_image"
											   value="<?php echo !empty($popup_image) ? $popup_image : '' ?>"
											   onclick="FUNC.chooseImage(this)" class="form-control m-input chooseImage"
											   placeholder="Click để chọn ảnh">
									</div>
									<div class="alert m-alert m-alert--default preview text-center mt-1" role="alert">
										<img height="70"
											 src="<?php echo !empty($popup_image) ? getImageThumb($popup_image, 100, 100) : '' ?>">
									</div>
								</div>

								<div class="form-group">
									<label>Chèn script ở Head</label>
									<textarea name="script_head" rows="10"
											  class="form-control"><?php echo !empty($script_head) ? $script_head : '' ?></textarea>
								</div>

								<div class="form-group">
									<label>Chèn script ở trước Body đóng</label>
									<textarea name="script_body" rows="10"
											  class="form-control"><?php echo !empty($script_body) ? $script_body : '' ?></textarea>
								</div>
							...
							<div class="tab-content">
								<?php if (!empty($this->config->item('language_name'))) foreach ($this->config->item('language_name') as $lang_code => $lang_name): ?>
									<div class="tab-pane <?php echo ($lang_code == 'vi') ? 'active' : ''; ?>"
										 id="tab_contact_<?php echo $lang_code; ?>">
										<div class="box-body">
						...
						<div class="tab-pane" id="tab_faq" role="tabpanel">
							<div class="box-body">
								<h3>Hỏi đáp nổi bật</h3>
								<?php
								for ($i = 0; $i < 5; $i++):
									?>
									<div class="row">
										<div class="col-md-4">
											<div class="form-group">
												<label for="">Tiêu đề <?php echo $i + 1 ?></label>
												<input type="text"
													   value="<?php echo !empty($faq[$i]['title']) ? $faq[$i]['title'] : ''; ?>"
													   name="faq[<?php echo $i ?>][title]" class="form-control">
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
												<label for="">Link</label>
												<input type="text" name="faq[<?php echo $i ?>][link]"
													   value="<?php echo !empty($faq[$i]['link']) ? $faq[$i]['link'] : ''; ?>"
													   class="form-control">
											</div>
										</div>
										<div class="col-md-4">
                                            ...
                                            <span class="input-group-text">
                                                <i class="la la-picture-o"></i>
													...
													<input type="text" name="faq[<?php echo $i ?>][thumb]"
														   value="<?php echo !empty($faq[$i]['thumb']) ? $faq[$i]['thumb'] : '' ?>"
														   onclick="FUNC.chooseImage(this)"
												...
												<div class="alert m-alert m-alert--default preview text-center mt-1"
													 role="alert">
													<img height="100"
														 src="<?php echo !empty($faq[$i]['thumb']) ? getImageThumb($faq[$i]['thumb'], 100, 100) : '' ?>">
												</div>
											</div>
										</div>
									</div>
						...
						<div class="tab-pane" id="tab_block" role="tabpanel">
							<div class="form-group">
								...
								<textarea name="block[header_top]"
										  class="form-control summernote"><?php echo !empty($block['header_top']) ? $block['header_top'] : ''; ?></textarea>
							</div>

							<div class="form-group">
								<label>Thông tin Copyright Footer</label>
								<textarea name="block[footer_copyright]"
										  class="form-control summernote"><?php echo !empty($block['footer_copyright']) ? $block['footer_copyright'] : ''; ?></textarea>
							</div>

							<div class="form-group">
								<label>Thông tin bảo hành</label>
								<textarea name="block[warranty]" id="block_warranty"
										  class="form-control summernote"><?php echo !empty($block['warranty']) ? $block['warranty'] : ''; ?></textarea>
							</div>

							<div class="form-group">
								<label>Quy định đổi trả</label>
								<textarea name="block[return]" id="block_return"
										  class="form-control summernote"><?php echo !empty($block['return']) ? $block['return'] : ''; ?></textarea>
							</div>

							<div class="form-group">
								<label>Tài khoản ngân hàng</label>
								<textarea name="block[bank]" id="block_bank"
										  class="form-control summernote"><?php echo !empty($block['bank']) ? $block['bank'] : ''; ?></textarea>
							</div>
						</div>
						<div class="tab-pane" id="tab_popup" role="tabpanel">
							<div class="form-group">
								...
								<div class="input-group m-input-group m-input-group--air">
									...
									<input type="text" name="block[popup][image]"
										   value="<?php echo !empty($block['popup']['enable']) ? $block['popup']['enable'] : '' ?>"
										   onclick="FUNC.chooseImage(this)" class="form-control m-input chooseImage"
										   placeholder="Click để chọn ảnh">
								</div>
								<div class="alert m-alert m-alert--default preview text-center mt-1" role="alert">
									<img width="100" height="100"
										 src="<?php echo !empty($block['popup']['enable']) ? getImageThumb($block['popup']['enable'], 100, 100) : '' ?>">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="m-input">
									<input data-switch="true" type="checkbox" name="block[popup][enable]"
										   class="switchBootstrap" <?php echo !empty($block['popup']['enable']) ? 'checked="checked"' : '' ?>>
								</div>
							</div>
							<div class="form-group">
								<label>Link</label>
								<input type="text" name="block[popup][link]" placeholder="Link"
									   value="<?php echo !empty($block['popup']['link']) ? $block['popup']['link'] : '' ?>"
									   class="form-control">
							</div>
							<div class="form-group">
								<label>Thời gian hiện khi vào trang web (Nhập số giây)</label>
								<input type="number" name="block[popup][time_start]"
									   value="<?php echo !empty($block['popup']['time_start']) ? $block['popup']['time_start'] : '30' ?>"
									   class="form-control">
							</div>
						</div>
						<div class="tab-pane" id="tab_system" role="tabpanel">
							<div class="form-group">
								...
								<div class="m-input">
									<input data-switch="true" type="checkbox" name="recaptcha_mode"
										   class="switchBootstrap" <?php echo !empty($recaptcha_mode) ? 'checked="checked"' : '' ?>>
								</div>
							</div>
