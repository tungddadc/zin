          ...
          <div class="m-portlet__head-tools">
            <ul class="nav nav-tabs m-tabs-line m-tabs-line--primary m-tabs-line--2x" role="tablist">
              <li class="nav-item m-tabs__item">
                <a class="nav-link m-tabs__link active show" data-toggle="tab" href="#tab_general" role="tab"
                   aria-selected="true">
              ...
              <li class="nav-item m-tabs__item">
                <a class="nav-link m-tabs__link" data-toggle="tab" href="#tab_faq" role="tab" aria-selected="false">
                  <i class="la la-bookmark"></i>
                  Hỏi đáp
                </a>
              </li>
                ...
                <?php if (!empty($this->config->item('language_name'))) foreach ($this->config->item('language_name') as $lang_code => $lang_name): ?>
                  <li class="nav-item">
                    <a class="nav-link <?php echo ($lang_code === $this->config->item('language_default')) ? 'active' : '' ?>"
                      ...
                      <img src="<?php echo $this->templates_assets . 'images/flag/' . $lang_code . '.png' ?>"
              ...
              <div class="tab-content">
                <?php if (!empty($this->config->item('language_name'))) foreach ($this->config->item('language_name') as $lang_code => $lang_name): ?>
                  <div
                    ...
                    <div class="form-group">
                      ...
                      <input name="meta[<?php echo $lang_code; ?>][address_office]" class="form-control"
                ...
                <div class="form-group">
                  ...
                  <div class="input-group m-input-group m-input-group--air">
                    ...
                    <input type="text" name="favicon" value="<?php echo !empty($favicon) ? $favicon : '' ?>"
                ...
                <div class="form-group">
                  ...
                  <div class="input-group m-input-group m-input-group--air">
                    ...
                    <input type="text" name="watermark" value="<?php echo !empty($watermark) ? $watermark : '' ?>"
                           onclick="FUNC.chooseImage(this)" class="form-control m-input chooseImage"
                           placeholder="Click để chọn ảnh">
                  </div>
                  <div class="alert m-alert m-alert--default preview text-center mt-1" role="alert">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" value="<?php echo !empty($faq[$i]['title'])?$faq[$i]['title']:''; ?>" name="faq[<?php echo $i ?>][title]" class="form-control">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="">Link</label>
                      <input type="text" name="faq[<?php echo $i ?>][link]" value="<?php echo !empty($faq[$i]['link'])?$faq[$i]['link']:''; ?>" class="form-control">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
