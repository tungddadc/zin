                ...
                <table class="data-table cart-table" id="shopping-cart-table">
                  ...
                  <tr class="first last">
                    <td class="a-right last" colspan="50">
                      <button title="Continue Shopping" class="button btn-continue" onclick="setLocation('#')"
                              type="button"><span>Continue Shopping</span></button>
                      <button name="update_cart_action" title="Update Cart" class="button btn-update" type="submit"
                              value="update_qty"><span>Update Cart</span></button>
                      <button name="update_cart_action" title="Clear Cart" class="button btn-empty"
                              id="empty_cart_button" type="submit" value="empty_cart"><span>Clear Cart</span></button>
                    </td>
                  </tr>
                  </tfoot>
                  <tbody>
                  ...
                  if (!empty($this->cart->contents())) foreach ($this->cart->contents() as $key => $item):
                    ...
                    <tr class="first odd">
                      ...
                      <td class="a-right"><span class="cart-price"> <span
                            class="price"><?php echo number_format($item['price']) ?> đ</span> </span></td>
                      <td class="a-center movewishlist"><input name="cart[<?php echo $key ?>][qty]" title="Qty"
                      ...
                      <td class="a-right movewishlist"><span class="cart-price"> <span
                            class="price"><?php echo number_format($item['subtotal']) ?> đ</span> </span></td>
                      <td class="a-center last"><a title="Remove item" class="button remove-item" href="#"><span><span>Remove item</span></span></a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                  </tbody>
                      ...
                      <div id="shipping-zip-form">
                        <ul class="form-list">
                          <li>
                            ...
                            <div class="input-box">
                              <input name="full_name" class="input-text fullwidth" type="text"
                          ...
                          <li>
                            ...
                            <div class="input-box">
                              <input name="address" class="input-text fullwidth" type="text"
                    ...
                    <div class="bill-shipping-form">
                      <ul class="form-list">
                        <li>
                          ...
                          <div class="input-box">
                            <input name="bill_address" class="input-text fullwidth" type="text" value="">
                          </div>
                        </li>
                        ...
                        <li>
                          ...
                          <div class="input-box">
                            <input name="shipped_time" class="input-text fullwidth" type="date" value="">
                          </div>
                        </li>
                        <li>
                          <label for="region_id" class="required">Nội dung</label>
                          <div class="input-box">
                            <textarea name="note" class="input-text fullwidth"rows="8"></textarea>
                          </div>
                        </li>
                      </ul>
                      <!--buttons-set11-->
                  ...
                  <div class="inner">
                      ...
                      <div class="payment-collapse">
                        <div class="item">
                          ...
                          <div class="ct" style="display: none;">
                            <div class="ct-info">
                              Sau khi nhận hàng xong, quý khách hàng thanh toán tiền cho nhân viên vận chuyển của chúng
                              tôi. Chỉ áp dụng cho khu vực giao hàng trong quy định về vận chuyển của chúng tôi.
                            </div>
                    ...
                    <div class="discount">
                      <div id="discount-coupon-form">
                        ...
                        <input name="code" class="input-text fullwidth" id="coupon_code" type="text" value="">
                        <button title="Apply Coupon" class="button coupon " onclick="CART.coupon_code()" type="button"
                    ...
                    <table class="table shopping-cart-table-total" id="shopping-cart-totals-table">
                      ...
                      <tr>
                        ...
                        <td class="a-right"><strong><span
                              class="price_sale"><?php echo formatMoney($this->cart->total()) ?></span></strong></td>
                      </tr>
                      </tfoot>
                      <tbody>
                      <tr>
                        <td class="a-left" colspan="1"> Tổng cộng</td>
                        <td class="a-right"><span class="price"><?php echo formatMoney($this->cart->total()) ?></span>
                        </td>
                      </tr>
                      </tbody>
                    </table>
                    ...
                    <ul class="checkout">
                      <li>
                        <button title="Thanh toán" class="button btn-proceed-checkout" type="button" onclick="CART.check_out()">
