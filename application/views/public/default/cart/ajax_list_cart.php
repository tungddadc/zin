                ...
                <li class="item <?php echo $i == 0 ? 'first' : '' ?>">
                    <div class="item-inner">
                        ...
                        <div class="product-details">
                            <div class="access">
                                <a onclick="CART.delete(this,'<?php echo $item['rowid'] ?>')"
                                   title="Bỏ sản phẩm này khỏi giỏ hàng" class="btn-remove1" href="javascript:;">Xóa</a>
                            </div>
                            <strong><?php echo $item['qty'] ?></strong> x <span
                                    class="price"><?php echo formatMoney($item['price']) ?></span>
