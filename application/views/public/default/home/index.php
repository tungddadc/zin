                    ...
                    <div id='rev_slider_4' class='rev_slider fullwidthabanner'>
                        <ul>
                            <li data-transition='random' data-slotamount='7' data-masterspeed='1000'
                                data-thumb='<?php echo $this->templates_assets ?>images/slide-img1.jpg'><img
                                        src='<?php echo $this->templates_assets ?>images/slide-img1.jpg' alt="slide-img"
                                ...
                                <div class="info">
                                    <div class='tp-caption ExtraLargeTitle sft  tp-resizeme ' data-endspeed='500'
                                         ...
                                         style='z-index:2;max-width:auto;max-height:auto;white-space:nowrap;'><span>Todays Deals</span>
                                    </div>
                            ...
                            <li data-transition='random' data-slotamount='7' data-masterspeed='1000'
                                data-thumb='<?php echo $this->templates_assets ?>images/slide-img2.jpg'><img
                                        src='<?php echo $this->templates_assets ?>images/slide-img2.jpg' alt="slide-img"
                                        data-bgposition='left top' data-bgfit='cover' data-bgrepeat='no-repeat'/>
                                <div class="info">
                                    ...
                                    <div class='tp-caption LargeTitle sfl  tp-resizeme ' data-endspeed='500'
                                         ...
                                         data-splitin='none' data-splitout='none' data-elementdelay='0.1'
                                         data-endelementdelay='0.1'
                                         style='z-index:3;max-width:auto;max-height:auto;white-space:nowrap;'>Hottest
                                        Deal
                                    </div>
                                    <div class='tp-caption Title sft  tp-resizeme small_text' data-endspeed='500'
