                                ...
                                <div class="product-shop col-lg-5 col-sm-5 col-xs-12">
                                    ...
                                    <div class="ratings">
                                        ...
                                        <p class="rating-links">
                                            <a href="#reviews_tabs" rel="nofollow" title="Phản hồi về sản phẩm">1 lượt phản hồi về sản phẩm này</a>
                                        </p>
                                    ...
                                    <div class="price-block">
                                        <div class="price-box">
                                            <p class="special-price"><span class="price-label">Giá khuyến mại</span>
                                                <span id="product-price-48" class="price"> 99.000 đ </span></p>
                                            <p class="old-price"><span class="price-label">Giá gốc:</span> <span
                                                        class="price"> 130.000 đ </span></p>
                                        ...
                                        <div class="add-to-cart">
                                            <div class="pull-left">
                                                <div class="custom pull-left"><span class="qty-label">Số lượng:</span>
                                                    <button onClick="let result = document.getElementById('qty'); let qty = result.value; if( !isNaN( qty ) &amp;&amp; qty &gt; 0 ) result.value--;return false;"
                                                            class="reduced items-count" type="button"><i
                                                                class="fa fa-minus">&nbsp;</i></button>
                                                    <input type="text" class="input-text qty" title="Qty" value="1"
                                                           maxlength="12" id="qty" name="qty">
                                                    <button onClick="let result = document.getElementById('qty'); let qty = result.value; if( !isNaN( qty )) result.value++;return false;"
                                                ...
                                                <div class="box-reviews1">
                                                    <div class="form-add">
                                                        <?php echo form_open('',['id' => 'review-form']) ?>
                                                            <h3>Phản hồi của khách hàng về sản phẩm "<?php echo $oneItem->title ?>"</h3>
                                                            <fieldset>
                                                                <h4>Bạn đánh giá sản phẩm này như thế nào ? <em class="required">*</em></h4>
                                                                <span id="input-message-box"></span>
                                                                <div id="product-review-table">
                                                                    <div class="rateit" data-id="<?php echo $oneItem->id ?>"
                                                                         data-rateit-value="<?php echo !empty($vote->avg) ? $vote->avg : 0 ?>"
                                                                         data-rateit-starwidth="16"
                                                                         data-rateit-starheight="16" data-rateit-min="0"
                                                                ...
                                                                <div class="review1">
                                                                    <ul class="form-list">
                                                                        ...
                                                                        <li>
                                                                            <label class="required " for="review_field">Phản hồi<em>*</em></label>
                                                                            <div class="input-box">
                                                        ...
                                                        <div class="item-img">
                                                            <div class="item-img-info"><a class="product-image"
                                                                    ...
                                                                    <img alt="Retis lapen casen"
                                                                         src="<?php echo $this->templates_assets ?>products-images/product1.jpg">
                                                                </a>
                                                    ...
                                                    <div class="item-inner">
                                                        <div class="item-img">
                                                            <div class="item-img-info"><a class="product-image"
                                                                                          ...
                                                                                          href="product_detail.html">
                                                                    <img alt="Retis lapen casen"
                                                                         src="<?php echo getImageThumb($item) ?>"> </a>
                                                                <div class="box-hover">
                                                                    <ul class="add-to-links">
                                                                        <li><a class="link-quickview"
                                                                               href="quick_view.html"></a></li>
                                                    ...
                                                    <div class="item-inner">
                                                        <div class="item-img">
                                                            <div class="item-img-info"><a class="product-image"
                                                                                          ...
                                                                                          href="product_detail.html">
                                                                    <img alt="Retis lapen casen"
                                                                         src="<?php echo $this->templates_assets ?>products-images/product3.jpg">
                                                                </a>
                                                                <div class="box-hover">
                                                                    <ul class="add-to-links">
                                                                        <li><a class="link-quickview"
                                                    ...
                                                    <div class="item-inner">
                                                        <div class="item-img">
                                                            <div class="item-img-info"><a class="product-image"
                                                                                          ...
                                                                                          href="product_detail.html">
                                                                    <img alt="Retis lapen casen"
                                                                         src="<?php echo $this->templates_assets ?>products-images/product4.jpg">
                                                                </a>
                                                    ...
                                                    <div class="item-inner">
                                                        <div class="item-img">
                                                            <div class="item-img-info"><a class="product-image"
                                                                                          ...
                                                                                          href="product_detail.html">
                                                                    <img alt="Retis lapen casen"
                                                                         src="<?php echo $this->templates_assets ?>products-images/product5.jpg">
                                                                </a>
                                                                <div class="box-hover">
                                                                    <ul class="add-to-links">
                                                                        <li><a class="link-quickview"
                                                    ...
                                                    <div class="item-inner">
                                                        <div class="item-img">
                                                            <div class="item-img-info"><a class="product-image"
                                                                                          ...
                                                                                          href="product_detail.html">
                                                                    <img alt="Retis lapen casen"
                                                                         src="<?php echo $this->templates_assets ?>products-images/product6.jpg">
                                                                </a>
                                                                <div class="box-hover">
                                                                    <ul class="add-to-links">
                                                                        <li><a class="link-quickview"
                                                    ...
                                                    <div class="item-inner">
                                                        <div class="item-img">
                                                            <div class="item-img-info"><a class="product-image"
                                                                                          ...
                                                                                          href="product_detail.html">
                                                                    <img alt="Retis lapen casen"
                                                                         src="<?php echo $this->templates_assets ?>products-images/product7.jpg">
                                                                </a>
                                                                <div class="box-hover">
                                                                    <ul class="add-to-links">
                                                                        <li><a class="link-quickview"
                                                    ...
                                                    <div class="item-inner">
                                                        <div class="item-img">
                                                            <div class="item-img-info"><a class="product-image"
                                                                                          ...
                                                                                          href="product_detail.html">
                                                                    <img alt="Retis lapen casen"
                                                                         src="<?php echo $this->templates_assets ?>products-images/product10.jpg">
                                                                </a>
                                                                <div class="new-label new-top-right">new</div>
                                                                <div class="box-hover">
                                                                    <ul class="add-to-links">
                                                    ...
                                                    <div class="item-inner">
                                                        <div class="item-img">
                                                            <div class="item-img-info"><a class="product-image"
                                                                                          ...
                                                                                          href="product_detail.html">
                                                                    <img alt="Retis lapen casen"
                                                                         src="<?php echo $this->templates_assets ?>products-images/product11.jpg">
                                                                </a>
                                                                <div class="box-hover">
                                                                    <ul class="add-to-links">
                                                                        <li><a class="link-quickview"
                                                    ...
                                                    <div class="item-inner">
                                                        <div class="item-img">
                                                            <div class="item-img-info"><a class="product-image"
                                                                                          ...
                                                                                          href="product_detail.html">
                                                                    <img alt="Retis lapen casen"
                                                                         src="<?php echo $this->templates_assets ?>products-images/product13.jpg">
                                                                </a>
                                                                <div class="new-label new-top-left">new</div>
                                                                <div class="box-hover">
                                                                    <ul class="add-to-links">
                                                    ...
                                                    <div class="item-inner">
                                                        <div class="item-img">
                                                            <div class="item-img-info"><a class="product-image"
                                                                                          ...
                                                                                          href="product_detail.html">
                                                                    <img alt="Retis lapen casen"
                                                                         src="<?php echo $this->templates_assets ?>products-images/product14.jpg">
                                                                </a>
                                                                <div class="box-hover">
                                                                    <ul class="add-to-links">
                                                                        <li><a class="link-quickview"
                                                    ...
                                                    <div class="item-inner">
                                                        <div class="item-img">
                                                            <div class="item-img-info"><a class="product-image"
                                                                                          ...
                                                                                          href="product_detail.html">
                                                                    <img alt="Retis lapen casen"
                                                                         src="<?php echo $this->templates_assets ?>products-images/product16.jpg">
                                                                </a>
                                                                <div class="box-hover">
                                                                    <ul class="add-to-links">
                                                                        <li><a class="link-quickview"
