                                        ...
                                        <div class="agency">
                                            <div class="panel panel-danger">
                                                ...
                                                <div class="panel-body">
                                                    <a href="" class="btn btn-warning btn-block" title="Điều kiện và chính sách đại lý">Điều kiện và chính sách đại lý</a>
                                                    <a href="" class="btn btn-warning btn-block" title="Giá đại lý và ưu đãi">Giá đại lý và ưu đãi</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="product-shop col-lg-5 col-sm-5 col-xs-12">
                                    ...
                                    <div class="price-block">
                                        <div class="price-box">
                                            ...
                                            <p class="availability in-stock pull-right"><span class="agency">Đại lý</span> <span>Còn hàng</span></p>
                                            ...
                                            <div class="panel-body">
                                                <div class="add-to-box">
                                                    <div class="add-to-cart">
                                                        ...
                                                        <button class="button btn-cart pull-right" title="Thêm vào giỏ hàng" type="submit">Thêm
                                                            vào giỏ
                                                        </button>
                                                    </div>
                            ...
                            <div class="row accessories">
                                <div class="col-lg-12 col-sm-12 col-xs-12">
                                    <div class="panel panel-danger">
                                        ...
                                        <div class="panel-body">
                                            <div class="col-sm-3 col-xs-6 item"><a href="" title=""><img src="<?php echo getImageThumb() ?>" alt="" class="img-thumbnail"></a></div>
                                            <div class="col-sm-3 col-xs-6 item"><a href="" title=""><img src="<?php echo getImageThumb() ?>" alt="" class="img-thumbnail"></a></div>
                                            <div class="col-sm-3 col-xs-6 item"><a href="" title=""><img src="<?php echo getImageThumb() ?>" alt="" class="img-thumbnail"></a></div>
                                            <div class="col-sm-3 col-xs-6 item"><a href="" title=""><img src="<?php echo getImageThumb() ?>" alt="" class="img-thumbnail"></a></div>
                                            <div class="col-sm-3 col-xs-6 item"><a href="" title=""><img src="<?php echo getImageThumb() ?>" alt="" class="img-thumbnail"></a></div>
                                    ...
                                    <div class="product-collateral">
                                        <div class="add_info">
                                            <ul id="product-detail-tab" class="nav nav-tabs product-tabs">
                                                <li class="active"><a href="#product_tabs_description" data-toggle="tab">Đặc tính sản phẩm</a></li>
                                                ...
                                                <div class="tab-pane fade" id="reviews_tabs">
                                                    <div class="box-collateral box-reviews" id="customer-reviews">
                                                        ...
                                                        <div class="box-reviews2">
                                                            ...
                                                            <div class="actions">
                                                                <a class="button view-all" id="revies-button" href="#"><span><span>Xem thêm</span></span></a>
                                                            </div>
                                                        </div>
                                                        <div class="clear"></div>
                                                    </div>
