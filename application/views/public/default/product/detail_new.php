    ...
    <section class="main-container col1-layout">
        <div class="container">
            <div class="row">
                ...
                <div id="ajax-quickview" class="product-essential col-xs-12">
                    <div class="slide-detail">
                        <div class="col-md-8 col-sm-7 col-xs-12 column">
                            <div class="hidden-xs col-md-2 column">
                            ...
                            <div class="col-xs-12 col-md-10 column">
                            ...
                            <div class="product-box-right">
                                ...
                                <div class="add-to-box clear-after">
                                    <div class="add-to-cart clear-after" data-id="<?php echo $oneItem->id ?>">
                                        ...
                                        <button class="button btn-cart" title="Thêm vào giỏ hàng" type="submit">
                                            <i class="icon-cart fa fa-cart-plus"></i>
