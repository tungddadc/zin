            ...
            <div class="row">
                ...
                <aside class="col-left sidebar col-sm-3 col-xs-12 col-sm-pull-9">
                                ...
                                <li class="item"><a href="shopping_cart.html" title="Fisher-Price Bubble Mower"
                                    ...
                                    <div class="product-details">
                                        <div class="access"><a href="shopping_cart.html" title="Remove This Item"
                                                               class="btn-remove1"> <span class="icon"></span> Remove
                                            </a></div>
                                        <strong>1</strong> x <span class="price">$19.99</span>
                                        <p class="product-name"><a href="shopping_cart.html">Retis lapen casen...</a>
                                        </p>
                                    </div>
                                </li>
                    ...
                    <label for="vote_8">Compare Products</label>
                                ...
                                <div class="actions">
                                    <button type="submit" title="Vote" class="button button-vote"><span>Vote</span>
                                    </button>
                                </div>
                            </div>
                        </form>
