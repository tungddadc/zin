  ...
  <section class="main-container" style="margin-top: 0">
    ...
    <div class="top-agency">
      ...
      <div class="top-agency__abs">
        <ul>
          <li>
            <img src="<?php echo $this->templates_assets.'images/boy-1299640_960_720.png' ?>" alt=""><b class="so" id="total_agency" data-val="<?php echo countAgency() ?>"><?php echo countAgency() ?></b> CỬA HÀNG
            <p>Trên toàn quốc</p>
          </li>
          <li>
            <img src="<?php echo $this->templates_assets.'images/Customer-png.png' ?>" alt=""><b class="so" id="serve_customer" data-val="<?php echo countMember() ?>"><?php echo countMember() ?></b> KHÁCH
            <p>được phục vụ mỗi ngày</p>
          </li>
          <li>
            <img src="<?php echo $this->templates_assets.'images/customer_service_png_357586.png' ?>" alt=""><b><?php echo $this->settings['open_door'] ?></b> MỞ CỬA
