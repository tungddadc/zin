                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" height="100%"
                                        ...
                                        <tr>
                                            <td style="background:white;color:#525252;font-family:'Helvetica Neue',Arial,sans-serif;font-size:15px;line-height:22px;overflow:hidden;padding:40px 40px 30px">
                                                <p>
                                                    <span>Xin chào <b><?php echo $oneAccount->email; ?></b>,</span>
                                                </p>
                                                <p>Bạn vừa có 1 đơn hàng mới:</p>
                                                <p>Tài khoản: <strong><?php echo $oneAccount->fullname . " (Account ID: $oneAccount->id)"; ?></strong></p>
                                                ...
                                                <table border="1" style="border-collapse: collapse;width: 100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th align="center">Số tiền về ví</th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                    <?php if (!empty($oneProduct)): ?>
                                                        <tr>
                                                            <td align="center">
                                                            ...
                                                            <td align="center"><strong> +<?php echo $pointSeller ?></strong> đ</td>
                                                        </tr>
                                                    <?php endif; ?>
                                                    </tbody>
                                                </table>
