              ...
              <?php else: ?>
                ...
                <div class="dropdown block-company-wrapper hidden-xs">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li role="presentation">
                      <a href="<?php echo base_url('auth/window/Facebook') ?>" title="Đăng nhập bằng Facebook"
                    ...
                    <li role="presentation">
                      <a href="<?php echo base_url('auth/window/Google') ?>" title="Đăng nhập bằng Google"
                    ...
                    <li role="presentation">
                      <a
                        ...
                        title="Đăng nhập bằng Zalo" class="btn btn-block btn-social btn-zalo">
                          ...
                          <ul class="nav">
                            <?php foreach ($item->list_child as $itemChild): ?>
                              <li><a href="<?php echo getUrlBrand($itemChild) ?>"
                                     title="<?php echo getTitle($itemChild) ?>"><?php echo $itemChild->title ?></a></li>
                            <?php endforeach; ?>
                          </ul>
                        </div>
                      </div>
