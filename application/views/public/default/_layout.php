...
<head>
	...
	<script>
		...
		fbq('init', '448754032452208');
		fbq('track', 'PageView');
	</script>
	<noscript><img height="1" width="1" style="display:none"
				   src="https://www.facebook.com/tr?id=448754032452208&ev=PageView&noscript=1"
		/></noscript>
...
<?php if($this->settings['popup_image']): ?>
	<div id="popup_newsletter" class="popup1">
		<div class="newsletter-sign-box" style="background-size: contain;background: #f8f8f8 url(<?php echo getImageThumb($this->settings['popup_image'],650,400,true) ?>) no-repeat scroll 100% 0px;">
			<div class="newsletter">
				<a href="javascript:;" title="<?php echo $this->settings['title'] ?>" rel="nofollow" class="x">
					<img src="<?php echo $this->templates_assets ?>images/f-box-close-icon.png" alt="close">
				</a>
