 ...
 */
$config['site_title']                 = "Website";       // Site Title, example.com
$config['admin_email']                = "admin@domain.com"; // Admin Email, admin@example.com
...
/*
 ...
 | Default: auth/
 */
$config['email_templates'] = 'public/default/auth/email/';
