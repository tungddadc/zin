var DatatableRecordSelectionDemo = function () {
    var t = {
        ...
        layout: {theme: "default", class: "", scroll: !0, height: 550, footer: !1},
        sortable: !0,
        pagination: !0,
        columns: [{
            field: "RecordID",
            ...
            title: "Currency",
            width: 100
        }, {field: "ShipDate", title: "Ship Date"}, {field: "Latitude", title: "Latitude"}, {
            field: "Status",
            title: "Status",
            template: function (t) {
                var e = {
    ...
    return {
        init: function () {
            !function () {
                ...
                var i = $("#local_record_selection").mDatatable(t);
                $("#m_form_status").on("change", function () {
                    i.search($(this).val().toLowerCase(), "Status")
                }), $("#m_form_type").on("change", function () {
                    i.search($(this).val().toLowerCase(), "Type")
                }), $("#m_form_status,#m_form_type").selectpicker(), i.on("m-datatable--on-check m-datatable--on-uncheck m-datatable--on-layout-updated", function (t) {
                    ...
                    for (var e = i.rows(".m-datatable__row--active").nodes().find('.m-checkbox--single > [type="checkbox"]').map(function (t, e) {
                        return $(e).val()
                    }), a = document.createDocumentFragment(), n = 0; n < e.length; n++) {
                        var l = document.createElement("li");
                        l.setAttribute("data-id", e[n]), l.innerHTML = "Selected record ID: " + e[n], a.appendChild(l)
                    }
                    $(t.target).find(".m_datatable_selected_ids").append(a)
                }).on("hide.bs.modal", function (t) {
                    $(t.target).find(".m_datatable_selected_ids").empty()
                })
            }(), function () {
                t.extensions = {checkbox: {}}, t.search = {input: $("#generalSearch1")};
                var i = $("#server_record_selection").mDatatable(t);
                $("#m_form_status1").on("change", function () {
                    i.search($(this).val().toLowerCase(), "Status")
                }), $("#m_form_type1").on("change", function () {
                    i.search($(this).val().toLowerCase(), "Type")
                }), $("#m_form_status1,#m_form_type1").selectpicker(), i.on("m-datatable--on-click-checkbox m-datatable--on-layout-updated", function (t) {
                    var e = i.checkbox().getSelectedId().length;
                    $("#m_datatable_selected_number1").html(e), 0 < e ? $("#m_datatable_group_action_form1").collapse("show") : $("#m_datatable_group_action_form1").collapse("hide")
                }), $("#m_modal_fetch_id_server").on("show.bs.modal", function (t) {
                    for (var e = i.checkbox().getSelectedId(), a = document.createDocumentFragment(), n = 0; n < e.length; n++) {
                        var l = document.createElement("li");
                        l.setAttribute("data-id", e[n]), l.innerHTML = "Selected record ID: " + e[n], a.appendChild(l)
                    }
                    $(t.target).find(".m_datatable_selected_ids").append(a)
