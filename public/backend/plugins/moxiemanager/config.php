<?php
    $root = $_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'public';
	...
	$moxieManagerConfig['filesystem.extensions'] = 'jpg,jpeg,png,ico, gif,html,htm,txt,docx,doc,pdf,mp3,mp4,flv';
