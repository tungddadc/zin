...
var myOptions={zoom:19,center:latlng,mapTypeId:google.maps.MapTypeId.ROADMAP,};var map=new google.maps.Map(document.getElementById("maps-location"),myOptions);var myMarker=new google.maps.Marker({position:latlng,map:map,title:site_name,icon:base_url+"public/images/Zin-map.png",label:{color:'#ce171f',fontWeight:'700',fontSize:'14px',text:site_name,},icon:{labelOrigin:new google.maps.Point(11,60),url:base_url+"public/images/Zin-map.png",size:new google.maps.Size(30,48),origin:new google.maps.Point(0,0),anchor:new google.maps.Point(11,40),},});var contentString='<div id="content">'+'<h2 style="font-size:14px;color:#ce171f;padding-top: 5px;">'+site_name+'</h2>'+'<p style="font-size:14px;">Hotline: '+phone_number+'</p>'+'<p style="font-size:14px;">Giờ mở cửa: '+Open_door+'</p>'+'</div>';var infowindow=new google.maps.InfoWindow({content:contentString});myMarker.addListener('click',function(){infowindow.open(map,myMarker);});};jQuery(document).ready(function(){"use strict";});var CountUp=function(target,startVal,endVal,decimals,duration,options){var lastTime=0;var vendors=['webkit','moz','ms','o'];for(var x=0;x<vendors.length&&!window.requestAnimationFrame;++x){window.requestAnimationFrame=window[vendors[x]+'RequestAnimationFrame'];window.cancelAnimationFrame=window[vendors[x]+'CancelAnimationFrame']||window[vendors[x]+'CancelRequestAnimationFrame'];}
...
if(jQuery('#gallery_01').length>0){jQuery("#gallery_01 .slider-items").owlCarousel({autoplay:false,items:4,itemsDesktop:[1024,3],itemsDesktopSmall:[900,2],itemsTablet:[600,3],itemsMobile:[320,2],navigation:true,navigationText:["<a class=\"flex-prev\"></a>","<a class=\"flex-next\"></a>"],slideSpeed:500,pagination:false});}},stickyMenuMain:function(){let header=document.getElementById('menu-main');let sticky=header.offsetTop;jQuery('.mega-menu-category').slideUp();window.onscroll=function(){if(window.pageYOffset>sticky){header.classList.add("sticky");}else{header.classList.remove("sticky");}
if(window.pageYOffset==0){}};},stickyBox:function(){if($('.sticky_box').length>0){$('.sticky_box').stick_in_parent();}},socialShare:function(){if($('#social-share').length>0){$('#social-share').jsSocials({shares:["facebook","googleplus","twitter"]});}},voteStar:function(){if($('.rateit').length>0){$('.rateit').bind('rated',function(e){e.preventDefault();let ri=$(this);let value=ri.rateit('value');ri.closest('form').find('[name="vote"]').val(value);});}},loadComment:function(page){let container=$('#comments');if(container.length>0){let product_id=container.data('id');container.find('.cmt-list').html('<div class="text-center"><i class="fa fa-spinner fa-spin ml-2" style=" margin-left:5px;color: #be1e2d;"></i></div>');setTimeout(function(){$.ajax({type:'POST',url:base_url+'product/ajax_load_comment',data:{product_id:product_id,page:page},success:function(html){container.find('.cmt-list').html(html);}})},1000);}
return false;},show_random_realtime:function(){if(typeof is_realtime_visitor!=="undefined"&&is_realtime_visitor==true){setInterval(function(){let number_random=Math.floor((Math.random()*10)+(Math.random()*3));console.log(number_random);toastr.options.positionClass="toast-bottom-left";toastr.info('Có '+number_random+' người đang xem sản phẩm này !','',{timeOut:10000});},15000);}},homeSlider:function(){var sync1=$("#sync1");var sync2=$("#sync2");sync1.owlCarousel({singleItem:true,slideSpeed:1000,navigation:true,pagination:false,afterAction:syncPosition,responsiveRefreshRate:200,navigation:true,navigationText:['<i class="fa fa-angle-left" aria-hidden="true"></i>','<i class="fa fa-angle-right" aria-hidden="true"></i>'],});sync2.owlCarousel({items:4,itemsDesktop:[1199,4],itemsDesktopSmall:[979,4],itemsTablet:[768,3],itemsMobile:[479,2],pagination:false,responsiveRefreshRate:100,afterInit:function(el){el.find(".owl-item").eq(0).addClass("synced");}});function syncPosition(el){var current=this.currentItem;$("#sync2").find(".owl-item").removeClass("synced").eq(current).addClass("synced")
if($("#sync2").data("owlCarousel")!==undefined){center(current)}}
$("#sync2").on("click",".owl-item",function(e){e.preventDefault();var number=$(this).data("owlItem");sync1.trigger("owl.goTo",number);});function center(number){var sync2visible=sync2.data("owlCarousel").owl.visibleItems;var num=number;var found=false;for(var i in sync2visible){if(num===sync2visible[i]){var found=true;}}
if(found===false){if(num>sync2visible[sync2visible.length-1]){sync2.trigger("owl.goTo",num-sync2visible.length+2)}else{if(num-1===-1){num=0;}
sync2.trigger("owl.goTo",num);}}else if(num===sync2visible[sync2visible.length-1]){sync2.trigger("owl.goTo",sync2visible[1])}else if(num===sync2visible[0]){sync2.trigger("owl.goTo",num-1)}}},productCarousel:function(){$('#slide1').slick({slidesToShow:1,slidesToScroll:1,arrows:true,dots:false,fade:true,centerMode:true,asNavFor:'#slide2',prevArrow:"<a class='slick-btn-prev'><i class='fa fa-angle-left' aria-hidden='true'></i></a>",nextArrow:"<a class='slick-btn-next'><i class='fa fa-angle-right' aria-hidden='true'></i></a>"});$('#slide2').slick({slidesToShow:5,slidesToScroll:1,arrows:false,asNavFor:'#slide1',focusOnSelect:true,vertical:true});},accessoriesCarousel:function(){$('.accessories-slider').owlCarousel({items:1,loop:true,responsiveClass:true,nav:true,autoplay:true,autoplayTimeout:3000,autoplayHoverPause:true,})},relatedProduct:function(){jQuery('#related-products-slider .slider-items').owlCarousel({items:4,itemsDesktop:[1024,4],itemsDesktopSmall:[900,3],itemsTablet:[600,2],itemsMobile:[320,1],navigation:true,navigationText:['<a class=\"flex-prev\"></a>','<a class=\"flex-next\"></a>'],slideSpeed:500,pagination:false});},init:function(){UI.homeSlider();UI.productCarousel();UI.activeMenu();UI.searchBox();UI.stickyBox();UI.socialShare();UI.voteStar();UI.ajaxFormSubmit();UI.zoomImageProduct();UI.loadComment(1);UI.show_random_realtime();UI.accessoriesCarousel();},};jQuery(document).ready(function(){UI.init();WISHLIST.init();COMPARE.init();if(window.location.hash==='#reviews_tabs'){let tabClick=window.location.hash;$('[href="'+tabClick+'"]').tab('show');setTimeout(function(){$('html, body').animate({scrollTop:$(tabClick).offset().top-120},1000);},500);}
