...
$moxieManagerConfig['general.temp_dir'] = $root.'/media';
...
$moxieManagerConfig['filesystem.extensions'] = 'jpg,jpeg,png,ico,gif,7z,zip,rar,jar,tar,tar,gz,cab';
...
$moxieManagerConfig['upload.extensions'] = 'jpg,jpeg,png,ico,gif,7z,zip,rar,jar,tar,tar,gz,cab';
...
$moxieManagerConfig['upload.chunk_size'] = '500MB';
...
$moxieManagerConfig['thumbnail.width'] = 300;
...
$moxieManagerConfig['authenticator.login_page'] = '/admin/auth/login';

// SessionAuthenticator
$moxieManagerConfig['SessionAuthenticator.logged_in_key'] = 'MyLoggedInKey';
$moxieManagerConfig['SessionAuthenticator.user_key'] = 'identity';
...
$moxieManagerConfig['CodeIgniterAuthenticator.user_key'] = 'identity';
