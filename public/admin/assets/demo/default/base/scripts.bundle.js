this.Element && function (e) {
    e.matches = e.matches || e.matchesSelector || e.webkitMatchesSelector || e.msMatchesSelector || function (e) {
        for (var t = this, a = (t.parentNode || t.document).querySelectorAll(e), n = -1; a[++n] && a[n] != t;) ;
        return !!a[n]
    }
    ...
    window.requestAnimationFrame || (window.requestAnimationFrame = function (e) {
        var t = (new Date).getTime(), a = Math.max(0, 16 - (t - o)), n = window.setTimeout(function () {
            e(t + a)
        }, a);
        return o = t + a, n
    ...
    e.hasOwnProperty("prepend") || Object.defineProperty(e, "prepend", {
        ...
        writable: !0,
        value: function () {
            var e = Array.prototype.slice.call(arguments), a = document.createDocumentFragment();
...
var mUtil = function () {
    var t = [], a = {sm: 544, md: 768, lg: 1024, xl: 1200}, n = function () {
        var e = !1;
    ...
    return {
        init: function (e) {
            ...
            if (e) {
                var a = t.split(" ");
                if (e.classList) for (var n = 0; n < a.length; n++) a[n] && 0 < a[n].length && e.classList.add(mUtil.trim(a[n])); else if (!hasClass(e, t)) for (n = 0; n < a.length; n++) e.className += " " + mUtil.trim(a[n])
            }
            ...
            if (e = mUtil.get(e), void 0 !== a) e.style[t] = a; else {
...
$(document).ready(function () {
    ...
    b.fn.mDatatable = function (f) {
        if (0 !== b(this).length) {
            ...
            g.debug = !1;
            var h = {
                isInit: !(g.API = {record: null, value: null, params: null}),
                offset: 110,
                stateId: "meta",
                ajaxParams: {},
                init: function (e) {
                ...
                extractTable: function () {
                    var i = [], n = b(g).find("tr:first-child th").get().map(function (e, t) {
                    ...
                    f.columns = i;
                    var t = [], e = b(g).find("tr").get().map(function (e) {
                ...
                layoutUpdate: function () {
                    h.setupSubDatatable.call(), h.setupSystemColumn.call(), h.setupHover.call(), void 0 === f.detail && 1 === h.getDepth() && h.lockTable.call(), h.columnHide.call(), h.resetScroll(), h.isInit || (b(g).trigger("m-datatable--on-init", {
                        ...
                        options: f
                    }), h.isInit = !0), b(g).trigger("m-datatable--on-layout-updated", {table: b(g.wrap).attr("id")})
                },
                lockTable: function () {
                    var t = {
                        lockEnabled: !1, init: function () {
                            ...
                            b(g.table).find("thead,tbody,tfoot").each(function () {
                                ...
                                0 === b(this).find(".m-datatable__lock").length && b(this).ready(function () {
                                    !function (e) {
                                        if (0 < b(e).find(".m-datatable__lock").length) h.log("Locked container already exist in: ", e); else if (0 !== b(e).find(".m-datatable__row").length) {
                ...
                lockEnabledColumns: function () {
                    var a = b(window).width(), e = f.columns, n = {left: [], right: []};
                ...
                adjustLockContainer: function () {
                    ...
                    var e = b(g.tableHead).width(), t = b(g.tableHead).find(".m-datatable__lock--left").width(),
                ...
                dragResize: function () {
                    ...
                    b(g.tableHead).find(".m-datatable__cell").mousedown(function (e) {
                        ...
                        if (r) {
                            var n = b(s).index(), e = b(g.tableBody), t = b(s).closest(".m-datatable__lock");
                            if (t) {
                                var o = b(t).index();
                ...
                initHeight: function () {
                    if (f.layout.height && f.layout.scroll) {
                        var e = b(g.tableHead).find(".m-datatable__row").height(),
                            t = b(g.tableFoot).find(".m-datatable__row").height(), a = f.layout.height;
                ...
                scrollbar: function () {
                    var n = {
                        ...
                        onScrolling: function (e) {
                            var t = b(this).scrollLeft(), a = b(this).scrollTop();
                ...
                setHeadTitle: function (e) {
                    ...
                    var t = f.columns, o = b(e).find(".m-datatable__row"), i = b(e).find(".m-datatable__cell");
                ...
                dataRender: function (e) {
                    ...
                    var n = function () {
                        ...
                        var t = Math.max(e.perpage * (e.page - 1), 0), a = Math.min(t + e.perpage, e.total);
                        ...
                        var t = function (t, a) {
                            ...
                            var e = Math.max(a.perpage * (a.page - 1), 0), n = Math.min(e + a.perpage, a.total);
                            h.localDataUpdate(), g.dataSet = b(g.dataSet).slice(e, n), h.insertData()
                        };
                        if (b(g.wrap).removeClass("m-datatable--error"), f.pagination) if (f.data.serverPaging && "local" !== f.data.type) {
                            var a = h.getObject("meta", e || null);
                            null !== a ? h.paging(a) : h.paging(n(), t)
                        } else h.paging(n(), t); else h.localDataUpdate();
                        h.insertData()
                    };
                ...
                insertData: function () {
                    g.dataSet = g.dataSet || [];
                    var c = h.getDataSourceParam(), e = c.pagination, t = (Math.max(e.page, 1) - 1) * e.perpage,
                        a = Math.min(e.page, e.pages) * e.perpage, m = {};
                    ...
                    var m = {
                        ...
                        populate: function () {
                            ...
                            var n = h.getOption("toolbar.items.pagination.pages.desktop.pagesNumber"),
                                o = Math.ceil(m.meta.page / n) * n, i = o - n;
                            ...
                            0 == d.length && (d = [10, 20, 30, 50, 100]), b.each(d, function (e, t) {
                                var a = t;
                                -1 === t && (a = "All"), b("<option/>").attr("value", t).html(a).appendTo(s)
                            }), b(g).ready(function () {
                        ...
                        updatePerpage: function (e) {
                            e.preventDefault(), null === h.getOption("layout.height") && b("html, body").animate({scrollTop: b(g).position().top}), m.pager = b(g.table).siblings(".m-datatable__pager").removeClass("m-datatable--paging-loaded"), e.originalEvent && (m.meta.perpage = parseInt(b(this).val())), b(m.pager).find("select.m-datatable__pager-size").val(m.meta.perpage).attr("data-selected", m.meta.perpage), h.setDataSourceParam("pagination", {
                                page: m.meta.page,
                                pages: m.meta.pages,
                                perpage: m.meta.perpage,
                                total: m.meta.total
                        ...
                        pagingBreakpoint: function () {
                            ...
                            if (0 !== b(a).length) {
                                var n = h.getCurrentPage(), o = b(a).find(".m-pager-input").closest("li");
                ...
                columnHide: function () {
                    ...
                    b.each(f.columns, function (e, t) {
                        if (void 0 !== t.responsive) {
                            var a = t.field, n = b.grep(b(g.table).find(".m-datatable__cell"), function (e, t) {
                ...
                setupSubDatatable: function () {
                    ...
                    if ("function" == typeof l && !(0 < b(g.table).find(".m-datatable__subtable").length)) {
                        ...
                        var o = function (a) {
                            a.preventDefault();
                            var e = b(this).closest(".m-datatable__row"), t = b(e).next(".m-datatable__row-subtable");
                ...
                sortCallback: function (e, i, t) {
                    var l = t.type || "string", r = t.format || "", s = t.field;
                ...
                autoHide: function () {
                    ...
                    var e = function (e) {
                        e.preventDefault();
                        var t = b(this).closest(".m-datatable__row"), a = b(t).next();
                        if (b(a).hasClass("m-datatable__row-detail")) b(this).find("i").removeClass(h.getOption("layout.icons.rowDetail.expand")).addClass(h.getOption("layout.icons.rowDetail.collapse")), b(a).remove(); else {
                            ...
                            var o = b("<td/>").addClass("m-datatable__detail").attr("colspan", h.getTotalColumns()).appendTo(a),
                                i = b("<table/>");
                            b(n).each(function () {
                                var a = b(this).data("field"), e = b.grep(f.columns, function (e, t) {
                                    return a === e.field
                                })[0];
                ...
                setAutoColumns: function () {
                    h.getOption("data.autoColumns") && (b.each(g.dataSet[0], function (a, e) {
                        0 === b.grep(f.columns, function (e, t) {
                            return a === e.field
                        }).length && f.columns.push({field: a, title: a})
                ...
                hasOverflowY: function (e) {
                    var t = b(e).find(".m-datatable__row"), a = 0;
                ...
                sortColumn: function (e, o, i) {
                    ...
                    var l = b(e).index(), t = b(g.tableBody).find(".m-datatable__row"),
                        a = b(e).closest(".m-datatable__lock").index();
                    -1 !== a && (t = b(g.tableBody).find(".m-datatable__lock:nth-child(" + (a + 1) + ")").find(".m-datatable__row"));
                    var n = b(t).parent();
                        ...
                        init: function () {
                            ...
                            if (!b.isEmptyObject(e)) {
                                var t = b(g.tableHead).find('.m-datatable__cell[data-field="' + e.field + '"]').attr("data-sort", e.sort),
                                    a = b(t).find("span"), n = b(a).find("i"), o = h.getOption("layout.icons.sort");
                                0 < b(n).length ? b(n).removeAttr("class").addClass(o[e.sort]) : b(a).append(b("<i/>").addClass(o[e.sort]))
                            }
                        }, sortClick: function (e) {
                            var t = h.getDataSourceParam("sort"), a = b(this).data("field"), n = h.getColumnByField(a);
                ...
                localDataUpdate: function () {
                    ...
                    var e = h.getObject("sort.field", a), t = h.getObject("sort.sort", a), n = h.getColumnByField(e);
                    if (void 0 !== n && !0 !== h.getOption("data.serverSorting") ? "function" == typeof n.sortCallback ? g.dataSet = n.sortCallback(g.originalDataSet, t, n) : g.dataSet = h.sortCallback(g.originalDataSet, t, n) : g.dataSet = g.originalDataSet, "object" == typeof a.query && !h.getOption("data.serverFiltering")) {
                        ...
                        void 0 !== o && "" !== o && (o = o.toLowerCase(), g.dataSet = b.grep(g.dataSet, function (e) {
                            for (var t in e) if (e.hasOwnProperty(t) && "string" == typeof e[t] && -1 < e[t].toLowerCase().indexOf(o)) return !0;
                            return !1
                ...
                setDataSourceParam: function (e, t) {
                    g.API.params = b.extend({}, {
                        pagination: {page: 1, perpage: h.getOption("data.pageSize")},
                ...
                visible: function (e) {
                    if (b(h.recentNode.length)) {
                        ...
                        e ? (h.recentNode === h.nodeCols && delete f.columns[a].responsive, b(h.recentNode).show()) : (h.recentNode === h.nodeCols && h.setOption("columns." + a + ".responsive", {hidden: "xl"}), b(h.recentNode).hide()), h.redraw()
                    }
                },
                nodes: function () {
                    return h.recentNode
            ...
            }, f = b.extend(!0, {}, b.fn.mDatatable.defaults, f), g.options = f, h.init.apply(this, [f]), b(g.wrap).data("mDatatable", g)); else void 0 === (g = b(this).data("mDatatable")) && b.error("mDatatable not initialized"), f = g.options;
            return g
        }
...
var mDropdown = function (e, t) {
    var o = this, n = mUtil.get(e), i = mUtil.get("body");
    if (n) {
        var a = {
            toggle: "click",
            hoverTimeout: 300,
            ...
            construct: function (e) {
                ...
                var e = mUtil.outerWidth(n),
                    t = mUtil.hasClass(o.layout.arrow, "m-dropdown__arrow--right") ? "right" : "left", a = 0;
                ...
                o.events.push({name: e, handler: t, one: a, fired: !1})
            }
        };
...
var mHeader = function (e, t) {
    var i = this, a = mUtil.get(e), l = mUtil.get("body");
    if (void 0 !== a) {
        var n = {classic: !1, offset: {mobile: 150, desktop: 200}, minimize: {mobile: !1, desktop: !1}}, o = {
            construct: function (e) {
                ...
                i.events.push({name: e, handler: t, one: a, fired: !1})
            }
        };
    ...
    var p = this, a = !1, d = mUtil.get(e), i = mUtil.get("body");
    if (d) {
        var n = {
            ...
            construct: function (e) {
                ...
                if (!1 !== p.resumeDropdownHover() && "accordion" !== f.getSubmenuMode()) {
                    var t = this, a = p.options.dropdown.timeout, n = setTimeout(function () {
                ...
                if ("accordion" !== f.getSubmenuMode()) {
                    ...
                    if (0 < a.length && !1 === mUtil.hasClass(t, "m-menu__toggle") && 0 === t.querySelectorAll(".m-menu__toggle").length) for (var n = 0, o = a.length; n < o; n++) f.hideSubmenuDropdown(a[0], !0)
                }
            }, handleSubmenuAccordion: function (e, t) {
                var a, n = t || this;
                if ("dropdown" === f.getSubmenuMode() && (a = n.closest(".m-menu__item")) && "accordion" != a.getAttribute("m-menu-submenu-mode")) e.preventDefault(); else {
                    var o = n.closest(".m-menu__item"), i = mUtil.child(o, ".m-menu__submenu, .m-menu__inner");
                    if (!mUtil.hasClass(n.closest(".m-menu__item"), "m-menu__item--open-always") && o && i) {
                        ...
                        if (!1 === mUtil.hasClass(o, "m-menu__item--open")) {
                            if (!1 === p.options.accordion.expandAll) {
                                ...
                                if (r && s) for (var d = 0, c = s.length; d < c; d++) {
                ...
                if (!1 === p.options.accordion.expandAll && (t = d.querySelectorAll(".m-menu__item--open"))) for (n = 0, o = t.length; n < o; n++) mUtil.removeClass(a[0], "m-menu__item--open")
                ...
                p.events.push({name: e, handler: t, one: a, fired: !1})
            }
        };
...
var mOffcanvas = function (e, t) {
    var l = this, a = mUtil.get(e), n = mUtil.get("body");
    if (a) {
        var o = {}, i = {
            construct: function (e) {
                ...
                if (l.options.toggleBy) if ("string" == typeof l.options.toggleBy) mUtil.addEvent(l.options.toggleBy, "click", i.toggle); else if (l.options.toggleBy && l.options.toggleBy[0] && l.options.toggleBy[0].target) for (var e in l.options.toggleBy) mUtil.addEvent(l.options.toggleBy[e].target, "click", i.toggle); else l.options.toggleBy && l.options.toggleBy.target && mUtil.addEvent(l.options.toggleBy.target, "click", i.toggle);
                ...
                if (l.options.toggleBy && l.options.toggleBy[0] && l.options.toggleBy[0].target) for (var o in l.options.toggleBy) l.options.toggleBy[o].target === n && (a = l.options.toggleBy[o]); else l.options.toggleBy && l.options.toggleBy.target && (a = l.options.toggleBy);
                if (a) {
                ...
                l.events.push({name: e, handler: t, one: a, fired: !1})
            }
        };
    ...
    var s = this, d = mUtil.get(e), c = mUtil.get("body");
    if (d) {
        var a = {
            bodyToggleSpeed: 400,
            tooltips: !0,
            ...
            construct: function (e) {
                ...
                if (s.options.tooltips) {
                    ...
                    if (a) {
                        var n = t ? "bottom" : "top", o = new Tooltip(a, {
                ...
                return s.events.push({name: e, handler: t, one: a, fired: !1}), s
            }
        };
    ...
    var n = this, a = mUtil.get(e), o = mUtil.get("body");
    if (a) {
        var l = {
            mode: "default",
            minLength: 1,
            ...
            construct: function (e) {
                ...
                return n.events.push({name: e, handler: t, one: a, fired: !1}), n
            }
        };
    ...
    var o = this, a = mUtil.get(e), n = mUtil.get("body");
    if (a) {
    ...
    var l = this, o = mUtil.get(e);
    mUtil.get("body");
    if (o) {
        var a = {startStep: 1, manualStepForward: !1}, r = {
            construct: function (e) {
                ...
                mUtil.addEvent(l.btnNext, "click", function (e) {
                    ...
                    for (var e, t = this.closest(".m-wizard__step"), a = mUtil.parents(this, ".m-wizard__steps"), n = mUtil.findAll(a, ".m-wizard__step"), o = 0, i = n.length; o < i; o++) if (t === n[o]) {
                        e = o + 1;
                        break
                    }
                ...
                if (l.progress) if (mUtil.hasClass(o, "m-wizard--1")) {
                    var e = l.currentStep / l.totalSteps * 100, t = mUtil.find(o, ".m-wizard__step-number"),
                ...
                var e = l.steps[l.currentStep - 1], t = mUtil.get(mUtil.attr(e, "m-wizard-target")),
                ...
                return l.events.push({name: e, handler: t, one: a, fired: !1}), l
            }
        };
        return l.setDefaults = function (e) {
            a = e
...
!function (l) {
    ...
    var e, t, a, n, o, i, l, r = this._chart.ctx, s = this._view, d = s.borderWidth,
    ...
    if (s.horizontal ? (e = s.base, t = s.x, a = s.y - s.height / 2, n = s.y + s.height / 2, o = e < t ? 1 : -1, i = 1, l = s.borderSkipped || "left") : (e = s.x - s.width / 2, t = s.x + s.width / 2, o = 1, i = (a = s.y > 2 * c ? s.y - c : s.y) < (n = s.base) ? 1 : -1, l = s.borderSkipped || "bottom"), d) {
        var m = Math.min(Math.abs(e - t), Math.abs(a - n)), u = (d = m < d ? m : d) / 2,
            p = e + ("left" !== l ? u * o : 0), f = t + ("right" !== l ? -u * o : 0), g = a + ("top" !== l ? u * i : 0),
            h = n + ("bottom" !== l ? -u * i : 0);
        p !== f && (a = g, n = h), g !== h && (e = p, t = f)
    }
    r.beginPath(), r.fillStyle = s.backgroundColor, r.strokeStyle = s.borderColor, r.lineWidth = d;
    var b = [[e, n], [e, a], [t, a], [t, n]], v = ["bottom", "left", "top", "right"].indexOf(l, 0);
    ...
    return {
        init: function () {
            ...
            e = mUtil.get("m_aside_left"), t = mUtil.hasClass(e, "m-aside-left--offcanvas-default") ? "m-aside-left--offcanvas-default" : "m-aside-left", a = new mOffcanvas("m_aside_left", {
                ...
                var e = $("#m_ver_menu"), t = "1" === e.data("m-menu-dropdown") ? "dropdown" : "accordion";
...
var mQuickSidebar = function () {
    var n = $("#m_quick_sidebar"), o = $("#m_quick_sidebar_tabs"), e = n.find(".m-quick-sidebar__content"),
        t = function () {
            !function () {
                var t = $("#m_quick_sidebar_tabs_messenger");
                if (0 !== t.length) {
                    var a = t.find(".m-messenger__messages"), e = function () {
